...
#
    ...
    #print("Populating new environmental profiles")
    ...
    #print("Calculating reversible total specific entropy...")
    ...
    #print("Running through profiles...")
    for j in range(nlvl):
    ...
    #
    #print("Finding maximum level of buoyancy...")
    INB=0
    ...
    #print("Checking some more stuff...")
    if (INB==0):
        CAPED=0
        TOB=T[0]
        LNB=P[INB]
